<div class="p-10">
    ...
    <div class="mt-5 bg-gray-50 border border-dashed p-5 text-center">
        <p>
            ¿Deseas postularte para esta vacante?
    ...
    {{--
    Al tenerle que pasar el MODELO, se le tiene que indicar su CAMINO COMPLETO, sino no funciona,
    es decir, no vale con "Vacante::CLASS".
    --}}
