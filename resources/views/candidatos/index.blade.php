            ...
            <ul class="divide-y divide-gray-200 w-full">
              ...
              <li class="p-3 flex items-center">
                <div class="flex-1">
                  ...
                  <p class="text-sm font-medium text-gray-600">Día que se postuló: <span class="font-normal">{{
                      $candidato->created_at->diffForHumans() }}</span></p>
                </div>
                <div>
                  <a class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-gray-300 text-sm leading-5 font-medium rounded-full text-gray-700 bg-white hover:bg-gray-50"
                    href="{{ asset('storage/cv/'. $candidato->cv) }}" target="_blank" rel="noreferrer noopenner">Ver
                    CV</a>
                </div>
              </li>
              @empty
              <p class="p-3 text-center text-sm text-gray-600">No existen candidatos aún.</p>
              @endforelse
            </ul>
          </div>
        </div>
